/*
 * File: TProyectInterpreterDialog.java
 ...
 */
abstract public class TProyectInterpreterDialog extends TDialog {
	 ...
	 * 
	 */
	public TProyectInterpreterDialog(TInterpreter interpreter) {
	...
	/*protected TBoard getBoard() {
	 return interpreter.getCurrentBoard();
	 }
	 
	 protected TBoardContainer getBoardContainer() {
	 return interpreter.getCurrentBoardContainer();
	 }*/
