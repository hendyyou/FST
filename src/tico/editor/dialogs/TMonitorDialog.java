 ...
 */
public class TMonitorDialog extends TComponentDialog {
	private static String DEFAULT_TITLE = TLanguage.getString("TMonitorDialog.TITLE");
	...
	/**
	 * Creates a new <code>TMonitorDialog</code> to edit the <code>label</code>
	 * properties.
	 * 
	 * @param boardContainer The <code>boardContainer</code> which contains the
	 * cell to be edited
	 * @param monitor The <code>monitor</code> to be edited
	 */
	public TMonitorDialog(TBoardContainer boardContainer, TComponent monitor) {
		super(boardContainer, DEFAULT_TITLE, monitor);
	}
	...
	private void createTabbedPane() {
		...
		tabbedPane.addTab(TLanguage.getString("TMonitorDialog.TAB_TEXT"),
				textPropertiesPanel);
		tabbedPane.addTab(TLanguage.getString("TMonitorDialog.TAB_PROPERTIES"),
	...
	private void createTextField() {
		...
		textFieldPanel.setBorder(new TitledBorder(BorderFactory
				...
				TLanguage.getString("TMonitorDialog.TEXT")));
